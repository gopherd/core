...
func Run(s Service) {
	if err := RunWithFlagSet(s, flag.CommandLine); err != nil {
...
// RunWithFlagSet starts and manages the lifecycle of the given service with the given flag set.
// It's not recommended to use this function directly unless you need to customize the flag set.
func RunWithFlagSet(s Service, flagSet *flag.FlagSet) error {
